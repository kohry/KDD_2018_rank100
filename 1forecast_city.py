    ...
    if(rescode==200):
        ...
        try :
            ...
            # <REPLACE node with this if needed>
                ...
                temperature = raw['list'][ii]['main'] ['temp'] - 273.15
                pressure = raw['list'][ii]['main'] ['pressure']
                humidity = raw['list'][ii]['main'] ['humidity']
                weather = raw['list'][ii]['weather'][0]['main']
...
try :
    ...
    print('beijing')
    out = out.append(get_info('beijing', '39.9169', '116.3972')) #unit
    time.sleep(1) # API will possibly block your request without this. replace it if you want.

    print('london')
    out = out.append(get_info('london', '51.5085', '-0.1258')) #unit
